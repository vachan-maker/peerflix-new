        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="w-full aspect-video bg-black rounded-xl overflow-hidden border-4 border-black dark:border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] mb-6 relative z-10">
               {/* @ts-ignore */}
               <ReactPlayer url={video.videoUrl} width="100%" height="100%" controls playing light={video.thumbnailUrl} playIcon={<div className="w-20 h-20 bg-primary rounded-full flex items-center justify-center border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-110 transition-transform"><svg className="w-8 h-8 fill-white ml-1" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg></div>} />
            </div>
